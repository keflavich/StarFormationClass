...
\usepackage[colorlinks,pagebackref,pdfusetitle,urlcolor=darkblue,citecolor=darkblue,linkcolor=darkred,bookmarksnumbered,plainpages=false,pdflang=en-US,pdftitle=AST4930_syllabus2025_spring4930]{hyperref}
\renewcommand{\thefootnote}{\fnsymbol{footnote}}

\pagestyle{fancyplain}
\fancyhf{}
\lhead{ \fancyplain{}{AST4930 Star Formation} }
%\chead{ \fancyplain{}{} }
...
\title{AST 4930: Star Formation, Spring 2025}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\begin{center}
{\Large \textsc{AST 4930: Star Formation}}
\end{center}
\begin{center}
Spring 2021
\end{center}
...
\textbf{Instructor:} & Prof. Adam Ginsburg &  &  & \textbf{Time:} & M,W,F | Period 9 (16:05 - 16:55) \\
\textbf{Email:} &  \href{mailto:adamginsburg@ufl.edu}{adamginsburg@ufl.edu} & &  & \textbf{Place:} & FLG 0245\\
  &&&& \textbf{Office Hours:} & Friday 1pm-2pm and by appointment\\
\end{tabular}
\end{minipage}
...
Class periods will consist of lectures.
The course will be taught largely as a classic lecture course so that we can cover a wide range of material.
Active learning will be employed when possible.

Active Learning is when the learner is engaged directly by solving problems and
discussing or presenting material - i.e., not just listening and taking notes.
There is extensive evidence that active learning is more effective than passive
learning, but it only works when the student buys in to the process.

The primary assessment method in the course is via homeworks.
Homework is a form of asynchronous active learning.
The homeworks are set up as a combination of derivations, numerical problems, and discussion problems.
They are intended to provide practice with the methods discussed in class and to stimulate understanding of the science of star formation.


\vskip.15in
\noindent\textbf{Course Pages:} \begin{enumerate}
    \item \url{https://ufl.instructure.com/courses/526135}
    \item \url{https://github.com/keflavich/StarFormationClass}
\end{enumerate}


\vskip.15in
\noindent\textbf{Communication:}\\
Communication will be via e-mail, Canvas, \& Zoom.

\vskip.15in
\noindent\textbf{Office Hours:}\\
Office hours will be held in person, though zoom meetings can be scheduled as an alternative.
...
\begin{itemize}
    \item Star Formation Notes by Mark Krumholz \url{https://github.com/Open-Astrophysics-Bookshelf/star_formation_notes}, \url{https://open-astrophysics-bookshelf.github.io/}
...
You will learn the fundamentals of star formation, from gravitational collapse
...
%*: I do not guarantee that there will be exams; if there are, they will comprise 10\% of the grade, otherwise, grades will be based only on projects and class and homework.
...
grades; I will not apply a curve to reduce your score below the raw score.
...
%TODO: replace this for undergrad!
...
\item The instructor can be contacted via e-mail at adamginsburg@ufl.edu

\item Zoom will be used for remote meetings and/or recordings.

\item Regular attendance in person is essential and expected.
\end{itemize}
...
\vskip.15in
\noindent\textbf{Health absence policies}
...
\item	You are requested to wear approved face coverings when appropriate.
...
\vskip.15in
\noindent\textbf{Online Teaching Policy (applies only to Zoom class sessions)}
...
Submit homeworks via Canvas.  Always submit a pdf, and please also submit jupyter notebooks (ipynb) if you used them.

Some of the homeworks have problems tagged with (G).  
These problems are added for the graduate version of this class.
You may attempt these for up to an additional 10\% of extra credit
 (I'm keeping this bonus small, given the amount of work, because I don't want to tempt you to go overboard).

You are allowed to use the textbook and class notes for the problem sets.
If you use any other resources, you are required to reference them.
If you choose to use AI resources, details of the queries must be included in the problem set writeup.

You may work with your classmates, but you must complete the work yourself; you will not learn anything by copying your peers' results.
If you work with classmates, you must report the names of all collaborators in the pdf you turn in.


\vskip.15in
\noindent\textbf{Homework schedule}
\begin{enumerate}
    \item Problem Set 1: Jan 13 - Jan 24
    \item Problem Set 2: Jan 24 - Feb 14
    \item Problem Set 3: Feb 14 - Feb 28
    \item Problem Set 4: Feb 18 - Mar 14
    \item Problem Set 5: Mar 24 - Apr 4
\end{enumerate}



\vskip.15in
\noindent\textbf{Preliminary Schedule }
...
\begin{itemize}
    ...
    \item The initial mass function \\
        %{\it Breaking the Law / Judas Priest} \\
        %alternative: {\it Wanna Be Startin Something / Michael Jackson}

    \item Star clustering \\
        %{\it We’re all in this together / High School Musical cast}
    \item Triggered star formation \\
        %{\it Winds of Change / Scorpions}
    \item Dust \\
        %{\it Dust in the Wind / Kansas}
\end{itemize}
...
\begin{itemize}
    ...
    \item Dust growth, protoplanet formation \\
        ...
        %Alternate suggestion: {\it Collide (NOW What's Next!) / EARTHGANG and Tiana Major9}
    \item Disk heating, passive disks \\
        %{\it Pancake Robot / Parry Gripp}
\end{itemize}
...
\begin{itemize}
    ...
    \item Photoionization, HII regions \\
        %{\it Burnin' for You / Blue {\"O}yster Cult }
\end{itemize}
...
\begin{itemize}
\item 1 \textbf{Observing the Cold Interstellar Medium }
 ...
 \item 7 \textbf{Stellar Feedback }
 \item 8 \textbf{Giant Molecular Clouds }
