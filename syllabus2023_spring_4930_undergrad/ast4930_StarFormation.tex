...
The Honor Code\footnote{\url{https://sccr.dso.ufl.edu/policies/student-honor-code-student-conduct-code/}}
...
\begin{itemize}
    \item Week 1 (Jan 9, 11, 13): Syllabus, meta-discussion, gravitational collapse (Krumholz Ch 6) \\
        Problem Set 1
    \item Week 2 (Jan 18, 20): Gravitational Collapse: Krumholz Ch 6, Megeath lecture 7 \\
        Problem Set 1
    ...
    \item Week 8 (Feb 27, Mar 1, 3): Outflows \\
...
However, these reviews are not yet available!  I will try to get ahold of some of them and share them early.
