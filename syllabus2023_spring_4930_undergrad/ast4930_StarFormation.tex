...
\usepackage[colorlinks,pagebackref,pdfusetitle,urlcolor=darkblue,citecolor=darkblue,linkcolor=darkred,bookmarksnumbered,plainpages=false,pdflang=en-US,pdftitle=AST4930_syllabus_spring2023]{hyperref}
...
\title{AST 4930: Star Formation, Spring 2023}
...
\textbf{Instructor:} & Prof. Adam Ginsburg &  &  & \textbf{Time:} & M,W,F | Period 5 (11:45 PM - 12:35 PM) \\
...
\noindent\textbf{Course Pages:} \begin{enumerate}
    \item \url{https://github.com/keflavich/AST4930_Prostars}
...
Submit via Canvas
\begin{enumerate}
    \item Problem Set 1: Jan 9 - Jan 24
    \item Problem Set 2: Jan 24 - Feb 14
    \item Problem Set 3: Feb 14 - Mar 4
    \item Problem Set 4: Mar 4 or 14 - Mar 28
    \item Problem Set 5: Mar 28 - Apr 20
\end{enumerate}
...
\begin{itemize}
    \item Week 1 (Jan 9, 11, 13): Syllabus, meta-discussion, molecular clouds \& gravitational collapse (Krumholz Ch 6) \\
        Problem Set 1
    \item Week 2 (Jan \sout{18}, 20): Molecular Clouds \& Gravitational Collapse: Krumholz Ch 6, Megeath lecture 7 [Jan 18: Adam is absent for review panel] \\
        Problem Set 1
    \item Week 3 (Jan 23, 25, 27): Cores \& Gravitational Collapse \\
        Problem Set 1 Due \\
        Problem Set 2
    \item Week 4 (Jan 30, Feb 1, 3): Protostar Formation: Krumholz ch 16, 17 \\
        Problem Set 2
    \item Week 5 (Feb 6, 8, 10): Accretion, Core temperature structure \\
    \item Week 6 (Feb 13, 15, 17): Protostellar evolution tracks \\
    \item Week 7 (Feb 20, 22, 24): Disks \\
        Problem Set 2 due, Problem Set 3
    \item Week 8 (Feb 27, Mar 
        \sout{1}, 3): Outflows [Mar 1: Adam is absent for review panel] \\
    \item Week 9 (Mar 6, 8, 10): Turbulence \\
        Problem set 3 due 
    \item Spring break.
        Problem set 4 
    \item Week 10 (Mar 20, 22, 24):  \\
    \item Week 11 (Mar 27, 29, \sout{31}):  [Mar 31: Adam is traveling for colloquium]\\
    \item Week 12 (Apr 3, 5, 7):  High-mass star formation \\
        Problem set 4 due Mar 28 \\
        Problem set 5 \\
    \item Week 13 (Apr \sout{10, 12, 14}): NO CLASS - Protostars and Planets VII \\
    \item Week 14 (Apr 17, 19, 21): The IMF \\
    \item Week 15 (Apr \sout{24, 26}):  NO CLASS - GCWS\\
